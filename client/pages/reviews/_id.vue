            ...
            <div class="a-spacing-top-medium">
              ...
              <div class="row">
                ...
                <div class="col-md-2 col-sm-3 col-3">
                  <img src="/img/spcBody.jpg" style="width: 80px" />
                </div>
                <!-- Product Title -->
    ...
    methods: {
        ...
        async onAddReview(){
            try {
                ...
                //data._id = $auth.$state.user._id;
                // data.photo = this.selectedFile;
                //data.fileName = this.fileName;
                console.log(data.headline + ' ' + data.body + ' ' +  data.rating)

                let response = await this.$axios.$post(`http://localhost:3030/api/reviews/${this.$route.params.id}`, {data});
